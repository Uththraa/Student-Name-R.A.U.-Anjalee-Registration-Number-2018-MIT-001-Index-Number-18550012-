...
class PDF extends FPDF
{
        ...
        $this->Cell(195,5,'Welcome to ESEB Information System!',0,0,"R");
            // Line break
            $this->Ln(5);
        $this->Cell(275,5,'SLEAS Officer"s List in Ministry of Education',0,0,"R");
...
$result = mysqli_query($connString, "SELECT EmpNo , Name , Class , Designation ,Location FROM `sleasofficer`WHERE PlaceOfWork  ='MOE'") or die("database error:". mysqli_error($connString));
...
$width_cell=array(35,60,20,40,120);
...
$pdf->Cell($width_cell[4],10,'BRANCH',1,1,'C',true); // Fourth header column
