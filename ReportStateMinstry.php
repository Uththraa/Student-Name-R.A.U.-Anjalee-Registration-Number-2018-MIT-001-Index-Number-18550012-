...
class PDF extends FPDF
{
        ...
        $this->Cell(195,5,'Welcome to ESEB Information System!',0,0,"R");
            // Line break
            $this->Ln(5);
        $this->Cell(275,5,'SLEAS Officer"s List in State Ministrys',0,0,"R");
...
$result = mysqli_query($connString, "SELECT EmpNo , Name , Class , Designation ,Location FROM `sleasofficer`WHERE PlaceOfWork  ='State Ministry'") or die("database error:". mysqli_error($connString));
...
$width_cell=array(20,35,20,40,160);
...
$pdf->Cell($width_cell[3],10,'DESIGNATION',1,0,'C',true); // Fourth header column
$pdf->Cell($width_cell[4],10,'MINISTRY',1,1,'C',true); // Fourth header column
