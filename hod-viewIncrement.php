         ...
         <div class="content-wrapper">
            ...
            <div class="content-header">
               <div class="container-fluid">
                  ...
                  <!-- ////////////////////////////////////////////////////////////-->
                  <div id = "increment_hod_appproval">
                     <div class="row mb-2">
                        <div class="col-sm-6">
                                 ...
                                 <form class="form-horizontal" padding="10">
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="col-sm-2">
                                          <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                             ...
                                             <input type="radio" name="options1"  autocomplete="off" checked="" value="No" class="hodbuttons"> No
                                             </label>
                                             <label class="btn btn-warning">
                                             <input type="radio" name="options1"  autocomplete="off" value="Yes" class="hodbuttons"> Yes
                                             </label>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="form-group row">
                                       ...
                                       <div class="col-sm-2">
                                          <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                             <label class="btn btn-warning active">
                                             <input type="radio" name="options2"  autocomplete="off" checked="" value="No" class="hodbuttons"> No
                                             </label>
                                             <label class="btn btn-warning">
                                             <input type="radio" name="options2"  autocomplete="off" value="Yes" class="hodbuttons"> Yes
                                             </label>
                                          </div>
                                       </div>
                                    </div>
...
<script>
   ...
   $(".btnView").click(function() {
    ...
    $('input[name="options1"][value="' + salarystatus + '"]').prop('checked', true);
   ...
   if(confirm("Do you want to approve a record ?")){
      ...
      $.ajax({
       type: 'POST',
       url: "process/hod_incrementApprovalProcess.php",
   ...
   if(confirm("Do you want to reject the request ?")){
       ...
       $.ajax({
       type: 'POST',
       url: "process/hod_incrementRejectlProcess.php",
