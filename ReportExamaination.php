...
class PDF extends FPDF
{
        ...
        $this->Cell(110,5,'Welcome to ESEB Information System!',0,0,"R");
            // Line break
            $this->Ln(5);
        $this->Cell(190,5,'SLEAS Officer"s List in Department Of Examination',0,0,"R");
...
$result = mysqli_query($connString, "SELECT EmpNo , Name , Class , Designation  FROM `sleasofficer`WHERE PlaceOfWork  ='Examination'") or die("database error:". mysqli_error($connString));
