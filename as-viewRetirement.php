<?php 
   ...
   $query = $db->getRows('SELECT *
                        ...
                        WHERE Progress  = ? OR Progress=? AND HOOApprovalStatus !=? 
         ...
         <div class="content-wrapper">
            ...
            <div class="content-header">
               <div class="container-fluid">
                  ...
                  <!-- ////////////////////////////////////////////////////////////////////////////////// -->
                  <div id="viewRequest_retirement_approval">
                     <div class="row mb-2">
                        <div class="col-sm-6">
                              ...
                              <div class="card-body">
                                 ...
                                 <form class="form-horizontal" padding="10">
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="col-sm-2">
                                          <input type="text" class="form-control" id="HOD_showreqdetails_One_txt" placeholder="I" disabled="">
                                       </div>
                                    </div>
                                    <div class="form-group row">
                                       ...
                                       <div class="col-sm-2">
                                          <input type="text" class="form-control" id="HOD_showreqdetails_two_txt" placeholder="I" disabled="">
                                       </div>
                                    </div>
                                    <div class="form-group row">
                                       ...
                                       <div class="col-sm-2">
                                          <input type="text" class="form-control" id="HOD_showreqdetails_three_txt" placeholder="I" disabled="">
                                       </div>
                                    </div>
                                    <div class="form-group row">
                                       ...
                                       <div class="col-sm-2">
                                          <input type="text" class="form-control" id="HOD_showreqdetails_four_txt" placeholder="I" disabled="">
                                       </div>
                                    </div>
                                    <!-- ....................................................... -->
                                    <div class="form-group row">
                                       ...
                                       <div class="col-sm-10">
                                          <input type="text" class="form-control" id="HOD_showreqdetails_comment_txt" placeholder="" disabled="">
                                       </div>
                                    </div>
                                 </form>
                                 <br>
                                 ...
                                 <form class="form-horizontal" padding="10">
                                    <div class="form-group row">
                                       <label for="inputapprovS" class="col-sm-10 col-form-label" id="HOD_showreqdetails_approvS_lbl">Approve the retirement of the officer.</label><br><br>
                                       <div class="col-lg-2">                          
                                       </div>
                                       <div class="col-8 ">
                                          <table>
...
<script>
   $(document).ready(function(){
    ...
    $('#viewRequest_retirement_approval').hide();
   ...
   $(".btnView").click(function() {
     ...
     $('#viewRequest_retirement_approval').show();
     ...
     $('#HOD_showreqdetails_One_txt').val(agreementbound);
     $('#HOD_showreqdetails_two_txt').val(salarystatus);
     $('#HOD_showreqdetails_three_txt').val(amountdue);
   ...
   if(confirm("Do you want to approve a record ?")){
       ...
       $.ajax({
       type: 'POST',
       url: "process/as_retirementApprovalProcess.php",
   ...
   if(confirm("Do you want to reject the request ?")){
       ...
       $.ajax({
       type: 'POST',
       url: "process/as_retirementRejectlProcess.php",
